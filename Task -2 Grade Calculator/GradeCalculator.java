...
public class GradeCalculator {
    ...
    public void inputmarks(int subjects) {
        ...
        for (int i=1; i<= sub; i++){
            System.out.print("Enter the marks obtained in subject - 0"+i + ": " );
            int marks = input.nextInt();

            if (marks < 0 || marks > 100){
                System.out.println("Please enter from the range 0 to 100");
                i--;
            }
            else{
